...
/*   Updated: 2025/07/24 06:49:11 by kilian           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(AForm& form)
{
	if (form.getIsSigned())
	{
		std::cout << _name << " can't sign something already signed." << std::endl;
		return ;
	}
	try
	{
...
void	Bureaucrat::executeForm(AForm const &form) const
{
	...
	{
		std::cerr << _name << " couldn't execute form because " << e.what() << '\n';
	}
